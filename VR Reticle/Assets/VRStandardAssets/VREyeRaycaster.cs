...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_DebugRayDuration = 0.5f;         // How long the Debug ray will remain visible.
        [SerializeField]
        ...
        private void EyeRaycast()
        {
            ...
            if (Physics.Raycast(ray, out hit, m_RayLength, ~m_ExclusionLayers)) // SI ESTÁ COLISIONANDO CON ALGO HAGA...
            {
